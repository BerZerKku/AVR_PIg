...
ПРОВЕРЕНО только в Р400м двухконцевом!!!
...
Изменения:
---> 21.11.2016 
	В Р400м убраны параметры защиты:
...
---> 22.11.2016
	Исправлена инициализация дисплея, чтобы устранить моргания первой строки в этот момент.
...
Изменения:
---> 01.09.2016
	В Р400М  изменена запись журнала событий "Ошибка контроля выходной цепи" на "Изменение параметров"
---> 25.08.2016
	Меню переделано под старый вариант дисплея и клавиатуры.
