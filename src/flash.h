...
static const char fcPrmFault0004opto[] PROGMEM = "Неиспр. канала";
...
//		 12345678901234567890
    ...
    "Неисправность канала",     ///< 16 кольцо
    "Вкл.пит/Перезапуск",       ///< 17
    "Изменение режима",         ///< 18
    "Блокировка ПРМ",           ///< 19 кольцо
    "Снятие блок. ПРМ",         ///< 20 кольцо
    ...
    "Нет КС",                   ///< 26
    "Нет КС 5 секунд",          ///< 27
    "Снятие неиспр канала",     ///< 28 кольцо
    "Уд: ПРД неисправен",       ///< 29
    "Уд: ПРМ неисправен",       ///< 30
    "Изменение дата/время",     ///< 31
    "Изменение параметров",     ///< 32
