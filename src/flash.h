...
/// Массив состояний управления передатчиком
static const char fcPrdComState[GB_PRD_COM_STATE_MAX + 1][NAME_PARAM_LENGHT] PROGMEM = {
    // 345678901234567890
    "                    ",  //
    "    Ввод команд ПРД ",  //
    "    Блок. команд ПРД",  //
...
static char fcJrnEventK400[MAX_JRN_EVENT_VALUE + 1][21] PROGMEM = {
    ...
    "Блок. команд ПРД",      ///< 38 добавлено 1.52
    "Разблок. команд ПРД",   ///< 39 добавлено 1.52
...
static char fcJrnEventOPTO[MAX_JRN_EVENT_VALUE + 1][21] PROGMEM = {
    ...
    "Блок. команд ПРД",      ///< 33 добавлено 1.52
    "Разблок. команд ПРД",   ///< 34 добавлено 1.52
    "Событие - 35",          ///< 35
    "Событие - 36",          ///< 36
    "Событие - 37",          ///< 37
    "Событие - 38",          ///< 38
...
/// Записи журнала событий для ОПТИКИ кольцо
...
static const char fcTest1K400[GB_SIGNAL_MAX + 1][STRING_LENGHT] PROGMEM = {
    ...
    "Команда2A",  "Команда3A",  "Команда4A",  "Команда5A",  "Команда6A",  "Команда7A",
    "Команда8A",  "Команда9A",  "Команда10A", "Команда11A", "Команда12A", "Команда13A",
    "Команда14A", "Команда15A", "Команда16A", "Команда17A", "Команда18A", "Команда19A",
    "Команда20A", "Команда21A", "Команда22A", "Команда23A", "Команда24A", "Команда25A",
    "Команда26A", "Команда27A", "Команда28A", "Команда29A", "Команда30A", "Команда31A",
    "Команда32A", "Команда1B",  "Команда2B",  "Команда3B",  "Команда4B",  "Команда5B",
    "Команда6B",  "Команда7B",  "Команда8B",  "Команда9B",  "Команда10B", "Команда11B",
    "Команда12B", "Команда13B", "Команда14B", "Команда15B", "Команда16B", "Команда17B",
    "Команда18B", "Команда19B", "Команда20B", "Команда21B", "Команда22B", "Команда23B",
    "Команда24B", "Команда25B", "Команда26B", "Команда27B", "Команда28B", "Команда29B",
    "Команда30B", "Команда31B", "Команда32B", "Команда1C",  "Команда2C",  "Команда3C",
    "Команда4C",  "Команда5C",  "Команда6C",  "Команда7C",  "Команда8C",  "Команда9C",
    "Команда10C", "Команда11C", "Команда12C", "Команда13C", "Команда14C", "Команда15C",
    "Команда16C", "Команда17C", "Команда18C", "Команда19C", "Команда20C", "Команда21C",
    "Команда22C", "Команда23C", "Команда24C", "Команда25C", "Команда26C", "Команда27C",
    "Команда28C", "Команда29C", "Команда30C", "Команда31C",
