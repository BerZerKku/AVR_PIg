...
private:
    ...
    typedef enum __attribute__((__packed__))
    {
        RESET_REMOTE_LINK = 0,  ///< \b <0> Сброс удаленного канала (FCV = 0).
                                //		RESET_OF_USER_PROCESS 		= 1,	///< \b <1>
                                //Сброс процесса пользователя (FCV = 0).
        ...
        USER_DATA_NO_REPLY = 4,  ///< \b <4> Пользовательские данные без ответа (FCV = 0).
                                 //		REQUEST_FOR_ACCESS_DEMAND 	= 8, 	///< \b <8>
                                 //Запрос доступа по требованию (FCV = 0).
    ...
    typedef enum __attribute__((__packed__))
    {
        ...
        RESPOND_STATUS_OF_LINK =
            11,  ///< \b <11> ОТВЕТ: состояние канала связи или запрос доступа.
                 //		LINK_SERV_NOT_FUNC		= 14,	///< \b <14> Канальный сервис
                 //не работает ("Услуги канала не работают").
