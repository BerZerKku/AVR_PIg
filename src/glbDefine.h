...
public:
    ...
    int8_t getFreqDev() const { return freqDev_; }
...
private:
     ...
     * 	бит: 7		6		5		4		3		2		1		0
     * ; b1 : x 		x 		x 		x 		x		x
     * [кч2]	[кч1]	; b2 : [ком8] [ком7]	[ком6] 	[ком5] 	[ком4] 	[ком3] 	[ком2] 	[ком1]	; b3
     * : [ком16][ком15] [ком14] [ком13] [ком12] [ком11] [ком10] [ком9]	; b4 : [ком24][ком23]
     * [ком22] [ком21] [ком20] [ком19] [ком18] [ком17]	; b5 : [ком32][ком31] [ком30] [ком29]
     * [ком28] [ком27] [ком26] [ком25]	; Установленный бит означает наличие данного сигнала на
     * передачу. Поиск ведется до первого установленного бита.
     ...
     * 	бит: 7	6	5	4	3		2		1		0
     * ; b1 : 0 	0 	0	0	[рз2] 	[рз1] 	[кч2] 	[кч1]	; b2 : 0	0
     * 0 	0 	[ком4] 	[ком3] 	[ком2] 	[ком1]	; Установленный бит означает наличие данного
     * сигнала на передачу. Если есть сигнал РЗ, но нет ни команд ни КЧ. Считаем что КЧ1 есть! рз1 +
     * комN = команда без блок; рз2 + комN = команда с блок; рз1 + кч2  = кч2 без блок; рз2 + кч2  =
     * кч2 с блок; рз1 + кч1  = кч без блок; рз2 + кч1  = кч с блок.
     * 	@param *s Указатель на массив данных.
     * 	@return Текущий тестовый сигнал.
     */
     ...
     * 	бит: 7		6		5		4		3		2		1		0
     * ; b1 : x 		x 		x 		[рз]	[кч4]	[кч3]
     * [кч2]	[кч1]	; Установленный бит означает наличие данного сигнала на передачу.
     ...
     * 	бит: 7		6		5		4		3		2		1		0
     *; b1 : x 		x 		x 		[рз]	x		x
     *x 		[кч]	; b2 : [ком8] [ком7]	[ком6] 	[ком5] 	[ком4] [ком3] 	[ком2]
     *[ком1]	; b3 : [ком16][ком15] [ком14] [ком13] [ком12] [ком11] [ком10] [ком9]	; b4 :
     *[ком24][ком23] [ком22] [ком21] [ком20] [ком19] [ком18] [ком17]	; b5 : [ком32][ком31]
     *[ком30] [ком29] [ком28] [ком27] [ком26] [ком25]	; Установленный бит означает наличие данного
     *сигнала на передачу. Поиск ведется до первого установленного бита.
     * 	@param *s Указатель на массив данных.
     * 	@return Текущий тестовый сигнал.
     */
     ...
     * 	бит: 7		6		5		4		3		2		1		0
     *; b1 : x 		x 		x 		[рз]	x		x
     *x 		[кч]	; b2 : [к8A]	[к7A]	[к6A] 	[к5A] 	[к4A] [к3A] 	[к2A] 	[к1A]
     *; b3 : [к16A]	[к15A] 	[к14A] 	[к13A] 	[к12A] 	[к11A] 	[к10A] 	[к9A]	; b4 : [к24A]
     *[к23A] 	[к22A] 	[к21A] 	[к20A] 	[к19A] 	[к18A] 	[к17A]	; b5 : [к32A]	[к31A] [к30A]
     *[к29A] 	[к28A] 	[к27A] 	[к26A] 	[к25A]	; b6 : [к8B]	[к7B]	[к6B] 	[к5B] [к4B] 	[к3B]
     *[к2B] 	[к1B]	; b7 : [к16B]	[к15B] 	[к14B] 	[к13B] 	[к12B] 	[к11B] 	[к10B] 	[к9B]	; b8
     *: [к24B]	[к23B] 	[к22B] 	[к21B] 	[к20B] 	[к19B] 	[к18B] 	[к17B]	; b9 : [к32B]	[к31B]
     *[к30B] 	[к29B] 	[к28B] 	[к27B] 	[к26B] 	[к25B]	; b10: [к8C]	[к7C]	[к6C] [к5C] 	[к4C]
     *[к3C] 	[к2C] 	[к1C]	; b11: [к16C]	[к15C] 	[к14C] 	[к13C] 	[к12C] [к11C] 	[к10C] 	[к9C]
     *; b12: [к24C]	[к23C] 	[к22C] 	[к21C] 	[к20C] 	[к19C] 	[к18C] 	[к17C]	; b13: [к32C]
     *[к31C]	[к30C] 	[к29C] 	[к28C] 	[к27C] 	[к26C] 	[к25C]	; Установленный бит означает наличие
     *данного сигнала на передачу. Поиск ведется до первого установленного бита.
     * 	@param *s Указатель на массив данных.
     * 	@return Текущий тестовый сигнал.
     */
