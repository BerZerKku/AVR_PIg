...
enum eGB_COM
{
    ...
    GB_COM_PRM_GET_PRM_DISABLE  = 0x1E,  //
    ...
    GB_COM_PRM_SET_PRM_DISABLE  = 0x9E,  //
...
private:
     ...
     * 	бит: 7		6		5		4		3		2
     *1 0 ; b1 : x 		x 		x 		[рз]	x		x x [кч]
     *; b2 : [ком8] [ком7]	[ком6] 	[ком5] 	[ком4] [ком3] 	[ком2] [ком1]	; b3 :
     *[ком16][ком15] [ком14] [ком13] [ком12] [ком11] [ком10] [ком9]	; b4 : [ком24][ком23]
     *[ком22] [ком21] [ком20] [ком19] [ком18] [ком17]	; b5 : [ком32][ком31] [ком30] [ком29]
     *[ком28] [ком27] [ком26] [ком25]	; Установленный бит означает наличие данного сигнала на
     *передачу. Поиск ведется до первого установленного бита.
     ...
     * 	бит: 7		6		5		4		3		2
     *1 0 ; b1 : x 		x 		x 		[рз]	x		x x [кч]
     *; b2 : [к8A]	[к7A]	[к6A] 	[к5A] 	[к4A] [к3A] 	[к2A] 	[к1A] ; b3 : [к16A] [к15A]
     *[к14A] 	[к13A] 	[к12A] 	[к11A] 	[к10A] 	[к9A]	; b4 : [к24A] [к23A] 	[к22A] [к21A]
     *[к20A] 	[к19A] 	[к18A] 	[к17A]	; b5 : [к32A]	[к31A] [к30A] [к29A] 	[к28A] [к27A]
     *[к26A] 	[к25A]	; b6 : [к8B]	[к7B]	[к6B] 	[к5B] [к4B] 	[к3B]
