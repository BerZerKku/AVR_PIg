...
public:
     ...
     *
     *  ! При смене смене роли пользвоателя Оператор, роли пользователей
     *  всех остальных источников доступа сменятся на Оператор.
     *
     *  @param[in] user Пользователь.
     *  @param[in] src Источник доступа.
     ...
     *
     *  В случае ошибки будет добавлено сообщение о вводе неправильного пароля
     *  или блокировке пользователя (за исключением USER_factory).
     *
