...
static const field_t commands[] PROGMEM = {
    ...
    {(eGB_COM) 0x35,            USER_operator,  true}, // FIXME Команда совпадает с GB_COM_GET_TIME_SINCHR. Проверить что это не мешает ПИ.
    {(eGB_COM) 0x00,            USER_operator,  true}, // FIXME Команда GB_COM_NO = 0x00 используется в конфигураторе. Проверить ее прохождение.
