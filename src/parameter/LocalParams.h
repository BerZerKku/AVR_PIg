...
public:
	...
	* 	Если параметр был изменен, то устаналивается флаг обновления \a refresh.
	...
	/**	Установка количества однотипных параметров.
	 *
	 * 	Используется в случае зависимости количества от чего-либо, например
	 * 	количества команд на передачу.
	 *
	 * 	В случае если кол-во повторений меньше 1, будет установлена 1.
	 *
	 * 	@param Количество однотипных параметров.
	 */
