...
public:
     ...
     *
     *  @param[in] pwd Значение пароля.
     */
    void setValuePwd(const uint8_t *pwd);
    ...
    /** Возвращает значение текущего пароля.
     *
     *  Возвращается строка из PWD_LEN символов с терминирующем нулем в конце.
     *
     *  @return Пароль.
     */
    uint8_t* getValuePwd();
...
private:
    ...
    /** Проверка установленного значения пароля.
     *
     *  Проверяются все символы на допустимые значения.
     *
