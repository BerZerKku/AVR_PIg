...
int16_t LocalParams::getMax() const
{
    ...
    switch (getDependMax())
    {
    case Param::DEPEND_MAX_NO: max = pgm_read_word(&getPtrParam()->max); break;
    case Param::DEPEND_MAX_ON_NUM_DEVS: max = numDevices; break;
    case Param::DEPEND_MAX_ON_COM_PRD: max = numComPrd;
    }
...
uint8_t LocalParams::getNumOfSameParams() const
{
    ...
    {
    case Param::DEPEND_SAME_NO: num = pgm_read_byte(&getPtrParam()->num); break;
