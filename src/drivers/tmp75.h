...
class TTmp75
{
    ...
    typedef enum __attribute__((__packed__))
    {
        ...
        I2C_STATE_REP_START = 0x10,  ///< Repeated START has been transmitted.
                                     //		STATE_ARB_LOST				= 0x38,	///< Arbitration
                                     //lost.
        ...
        //		STATE_STX_ADR_ACK			= 0xA8, ///< Own SLA+R has been
        //received; ACK has been returned 		STATE_STX_ADR_ACK_M_ARB_LOST= 0xB0, ///< Arbitration lost
        //in SLA+R/W as Master; own SLA+R has been received; ACK has been returned
        //		STATE_STX_DATA_ACK			= 0xB8, ///< Data byte in TWDR has
        //been transmitted; ACK has been received 		STATE_STX_DATA_NACK			= 0xC0, ///<
        ...
        //		STATE_SRX_ADR_ACK			= 0x60, ///< Own SLA+W has been
        //received ACK has been returned 		STATE_SRX_ADR_ACK_M_ARB_LOST= 0x68, ///< Arbitration lost
        //in SLA+R/W as Master; own SLA+W has been received; ACK has been returned 		STATE_SRX_GEN_ACK
