                 ...
                 TStopBits::STOP_BITS stopbits)
{
    ...
    switch (parity)
    {
    case TParity::NONE: ucsrc |= (0 << UPM1) | (0 << UPM0); break;
    case TParity::EVEN: ucsrc |= (1 << UPM1) | (0 << UPM0); break;
    case TParity::ODD: ucsrc |= (1 << UPM1) | (1 << UPM0); break;
    ...
    switch (stopbits)
    {
    case TStopBits::ONE: ucsrc |= (0 << USBS); break;
    case TStopBits::TWO: ucsrc |= (1 << USBS); break;
